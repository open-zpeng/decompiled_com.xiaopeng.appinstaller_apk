...
public class PathInterpolatorCompat implements Interpolator {
    ...
    public PathInterpolatorCompat(Resources res, Resources.Theme theme, AttributeSet attrs, XmlPullParser parser) {
        TypedArray a2 = TypedArrayUtils.obtainAttributes(res, theme, attrs, AndroidResources.STYLEABLE_PATH_INTERPOLATOR);
        parseInterpolatorFromTypeArray(a2, parser);
        a2.recycle();
    }

    private void parseInterpolatorFromTypeArray(TypedArray a2, XmlPullParser parser) {
        if (TypedArrayUtils.hasAttribute(parser, "pathData")) {
            String pathData = TypedArrayUtils.getNamedString(a2, parser, "pathData", 4);
            ...
            float x1 = TypedArrayUtils.getNamedFloat(a2, parser, "controlX1", 0, 0.0f);
            float y1 = TypedArrayUtils.getNamedFloat(a2, parser, "controlY1", 1, 0.0f);
            ...
            float x2 = TypedArrayUtils.getNamedFloat(a2, parser, "controlX2", 2, 0.0f);
            float y2 = TypedArrayUtils.getNamedFloat(a2, parser, "controlY2", 3, 0.0f);
