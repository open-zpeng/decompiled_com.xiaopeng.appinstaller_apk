...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a2 = ThemeEnforcement.obtainStyledAttributes(context, attrs, R.styleable.AppBarLayout, 0, R.style.Widget_Design_AppBarLayout);
        ...
        if (Build.VERSION.SDK_INT >= 21 && a2.hasValue(R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, a2.getDimensionPixelSize(R.styleable.AppBarLayout_elevation, 0));
        }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            if (a2.hasValue(R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                int resId = a2.getResourceId(R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0);
