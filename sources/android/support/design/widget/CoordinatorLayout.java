...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (defStyleAttr == 0) {
            a2 = context.obtainStyledAttributes(attrs, android.support.coordinatorlayout.R.styleable.CoordinatorLayout, 0, android.support.coordinatorlayout.R.style.Widget_Support_CoordinatorLayout);
        } else {
            a2 = context.obtainStyledAttributes(attrs, android.support.coordinatorlayout.R.styleable.CoordinatorLayout, defStyleAttr, 0);
        }
        int keylineArrayRes = a2.getResourceId(android.support.coordinatorlayout.R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a2.getDrawable(i2);
        a2.recycle();
        setupForInsets();
    ...
    private void resetTouchBehaviors(boolean notifyOnInterceptTouchEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            Behavior b2 = lp.getBehavior();
            if (b2 != null) {
                long now = SystemClock.uptimeMillis();
                MotionEvent cancelEvent = MotionEvent.obtain(now, now, 3, 0.0f, 0.0f, 0);
                if (notifyOnInterceptTouchEvent) {
                    b2.onInterceptTouchEvent(this, child, cancelEvent);
                } else {
                    b2.onTouchEvent(this, child, cancelEvent);
                }
                cancelEvent.recycle();
            }
        }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if ((intercepted || newBlock) && action != 0) {
                ...
                if (!intercepted && b2 != null) {
                    switch (type) {
                        case 0:
                            intercepted = b2.onInterceptTouchEvent(this, child, ev);
                            break;
                        case 1:
                            intercepted = b2.onTouchEvent(this, child, ev);
                            break;
                    }
                    if (intercepted) {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:46:0x0138, code lost:
        if (r29.onMeasureChild(r36, r4, r3, r23, r5, 0) == false) goto L34;
     */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    ...
    private WindowInsetsCompat dispatchApplyWindowInsetsToBehaviors(WindowInsetsCompat insets) {
        ...
        for (int i = 0; i < z; i++) {
            ...
            if (ViewCompat.getFitsSystemWindows(child)) {
                ...
                Behavior b2 = lp.getBehavior();
                if (b2 != null) {
                    insets = b2.onApplyWindowInsets(this, child, insets);
                    if (insets.isConsumed()) {
                        break;
                    }
                } else {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (type != 0 || child.getVisibility() != 8) {
                ...
                while (j3 < childCount) {
                    ...
                    Behavior b2 = checkLp.getBehavior();
                    if (b2 != null && b2.layoutDependsOn(this, checkChild, child)) {
                        if (type == 0 && checkLp.getChangedAfterNestedScroll()) {
                            checkLp.resetChangedAfterNestedScroll();
                        } else {
                            if (type == 2) {
                                b2.onDependentViewRemoved(this, checkChild, child);
                                handled = true;
                            } else {
                                handled = b2.onDependentViewChanged(this, checkChild, child);
                            }
    ...
    public void dispatchDependentViewsChanged(View view) {
        ...
        if (dependents != null && !dependents.isEmpty()) {
            for (int i = 0; i < dependents.size(); i++) {
                ...
                Behavior b2 = lp.getBehavior();
                if (b2 != null) {
                    b2.onDependentViewChanged(this, child, view);
                }
            }
        }
    }
    ...
    void offsetChildToAnchor(View child, int layoutDirection) {
        ...
        if (lp.mAnchorView != null) {
            ...
            if (changed && (b2 = lp.getBehavior()) != null) {
                b2.onDependentViewChanged(this, child, lp.mAnchorView);
            }
            releaseTempRect(anchorRect);
            releaseTempRect(childRect);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.dodgeInsetEdges = 0;
            this.mLastChildRect = new Rect();
            TypedArray a2 = context.obtainStyledAttributes(attrs, android.support.coordinatorlayout.R.styleable.CoordinatorLayout_Layout);
            this.gravity = a2.getInteger(android.support.coordinatorlayout.R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a2.getResourceId(android.support.coordinatorlayout.R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a2.getInteger(android.support.coordinatorlayout.R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a2.getInteger(android.support.coordinatorlayout.R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a2.getInt(android.support.coordinatorlayout.R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a2.getInt(android.support.coordinatorlayout.R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a2.hasValue(android.support.coordinatorlayout.R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a2.getString(android.support.coordinatorlayout.R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a2.recycle();
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (childId != -1 && b2 != null && (savedState = behaviorStates.get(childId)) != null) {
                b2.onRestoreInstanceState(this, child, savedState);
            }
        }
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            LayoutParams lp = (LayoutParams) child.getLayoutParams();
            Behavior b2 = lp.getBehavior();
            if (childId != -1 && b2 != null && (state = b2.onSaveInstanceState(this, child)) != null) {
