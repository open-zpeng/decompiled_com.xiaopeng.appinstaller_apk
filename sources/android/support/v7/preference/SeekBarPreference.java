...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mMin = a2.getInt(R.styleable.SeekBarPreference_min, 0);
        setMax(a2.getInt(R.styleable.SeekBarPreference_android_max, 100));
        setSeekBarIncrement(a2.getInt(R.styleable.SeekBarPreference_seekBarIncrement, 0));
        this.mAdjustable = a2.getBoolean(R.styleable.SeekBarPreference_adjustable, true);
        this.mShowSeekBarValue = a2.getBoolean(R.styleable.SeekBarPreference_showSeekBarValue, true);
        a2.recycle();
    }
