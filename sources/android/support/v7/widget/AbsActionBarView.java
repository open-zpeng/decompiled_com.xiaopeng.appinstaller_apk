...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a2 = getContext().obtainStyledAttributes(null, R.styleable.ActionBar, R.attr.actionBarStyle, 0);
        setContentHeight(a2.getLayoutDimension(R.styleable.ActionBar_height, 0));
        a2.recycle();
