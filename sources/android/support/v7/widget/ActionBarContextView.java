...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(context, attrs, R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a2.getDrawable(R.styleable.ActionMode_background));
        this.mTitleStyleRes = a2.getResourceId(R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a2.getResourceId(R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a2.getLayoutDimension(R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a2.getResourceId(R.styleable.ActionMode_closeItemLayout, R.layout.abc_action_mode_close_item_material);
        a2.recycle();
    }
