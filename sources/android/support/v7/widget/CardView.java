...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.CardView, defStyleAttr, R.style.CardView);
        if (a2.hasValue(R.styleable.CardView_cardBackgroundColor)) {
            valueOf = a2.getColorStateList(R.styleable.CardView_cardBackgroundColor);
        } else {
        ...
        float radius = a2.getDimension(R.styleable.CardView_cardCornerRadius, 0.0f);
        float elevation = a2.getDimension(R.styleable.CardView_cardElevation, 0.0f);
        float maxElevation = a2.getDimension(R.styleable.CardView_cardMaxElevation, 0.0f);
        this.mCompatPadding = a2.getBoolean(R.styleable.CardView_cardUseCompatPadding, false);
        this.mPreventCornerOverlap = a2.getBoolean(R.styleable.CardView_cardPreventCornerOverlap, true);
        int defaultPadding = a2.getDimensionPixelSize(R.styleable.CardView_contentPadding, 0);
        this.mContentPadding.left = a2.getDimensionPixelSize(R.styleable.CardView_contentPaddingLeft, defaultPadding);
        this.mContentPadding.top = a2.getDimensionPixelSize(R.styleable.CardView_contentPaddingTop, defaultPadding);
        this.mContentPadding.right = a2.getDimensionPixelSize(R.styleable.CardView_contentPaddingRight, defaultPadding);
        this.mContentPadding.bottom = a2.getDimensionPixelSize(R.styleable.CardView_contentPaddingBottom, defaultPadding);
        float maxElevation2 = elevation > maxElevation ? elevation : maxElevation;
        this.mUserSetMinWidth = a2.getDimensionPixelSize(R.styleable.CardView_android_minWidth, 0);
        this.mUserSetMinHeight = a2.getDimensionPixelSize(R.styleable.CardView_android_minHeight, 0);
        a2.recycle();
