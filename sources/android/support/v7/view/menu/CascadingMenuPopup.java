...
public final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener() { // from class: android.support.v7.view.menu.CascadingMenuPopup.3
        ...
        public void onItemHoverEnter(final MenuBuilder menu, final MenuItem item) {
            ...
            final CascadingMenuInfo nextInfo = nextIndex < CascadingMenuPopup.this.mShowingMenus.size() ? CascadingMenuPopup.this.mShowingMenus.get(nextIndex) : null;
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        if (parentView != null) {
            ...
            int parentOffsetY3 = this.mDropDownGravity;
            if ((parentOffsetY3 & 5) == 5) {
                if (showOnRight) {
