...
public class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(null, R.styleable.AlertDialog, R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a2.getResourceId(R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a2.getResourceId(R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a2.getResourceId(R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a2.getResourceId(R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a2.getResourceId(R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a2.getResourceId(R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a2.getBoolean(R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a2.getDimensionPixelSize(R.styleable.AlertDialog_buttonIconDimen, 0);
        a2.recycle();
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    adapter2 = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
                    ...
                    adapter2 = new CursorAdapter(this.mContext, this.mCursor, false) { // from class: android.support.v7.app.AlertController.AlertParams.2
                ...
                if (this.mCursor != null) {
                    ...
                    adapter = adapter3 != null ? this.mAdapter : new CheckedItemAdapter(this.mContext, layout, 16908308, this.mItems);
                }
            }
