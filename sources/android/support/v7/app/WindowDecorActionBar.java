...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ...
        if (a2.getBoolean(R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a2.getDimensionPixelSize(R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            ViewPropertyAnimatorCompat a2 = ViewCompat.animate(this.mContainerView).translationY(0.0f);
    ...
    public void doHide(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            ViewPropertyAnimatorCompat a2 = ViewCompat.animate(this.mContainerView).translationY(endingY);
            a2.setUpdateListener(this.mUpdateListener);
            anim.play(a2);
            if (this.mContentAnimations && this.mContentView != null) {
