...
public class PreferenceImageView extends ImageView {
    ...
    public PreferenceImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.PreferenceImageView, defStyleAttr, 0);
        setMaxWidth(a2.getDimensionPixelSize(R.styleable.PreferenceImageView_maxWidth, Preference.DEFAULT_ORDER));
        setMaxHeight(a2.getDimensionPixelSize(R.styleable.PreferenceImageView_maxHeight, Preference.DEFAULT_ORDER));
        a2.recycle();
    }
