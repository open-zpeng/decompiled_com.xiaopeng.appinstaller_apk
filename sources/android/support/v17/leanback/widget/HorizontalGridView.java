...
public class HorizontalGridView extends BaseGridView {
    ...
    protected void initAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.lbHorizontalGridView);
        setRowHeight(a2);
        setNumRows(a2.getInt(R.styleable.lbHorizontalGridView_numberOfRows, 1));
        a2.recycle();
        updateLayerType();
        this.mTempPaint = new Paint();
