...
public class SearchOrbView extends FrameLayout implements View.OnClickListener {
    ...
    public SearchOrbView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.lbSearchOrbView, defStyleAttr, 0);
        Drawable img = a2.getDrawable(R.styleable.lbSearchOrbView_searchOrbIcon);
        ...
        int color = a2.getColor(R.styleable.lbSearchOrbView_searchOrbColor, defColor);
        int brightColor = a2.getColor(R.styleable.lbSearchOrbView_searchOrbBrightColor, color);
        int iconColor = a2.getColor(R.styleable.lbSearchOrbView_searchOrbIconColor, 0);
