...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ServiceBinderImpl {
        ...
        public void connect(final String pkg, final int pid, final int uid, final Bundle rootHints, final ServiceCallbacks callbacks) {
            ...
            this.this$0.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                @Override // java.lang.Runnable
                public void run() {
                    IBinder b2 = callbacks.asBinder();
                    ServiceBinderImpl.this.this$0.mConnections.remove(b2);
                    ...
                    try {
                        ServiceBinderImpl.this.this$0.mConnections.put(b2, connection);
                        b2.linkToDeath(connection, 0);
        ...
        public void disconnect(final ServiceCallbacks callbacks) {
            this.this$0.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.2
                @Override // java.lang.Runnable
                public void run() {
                    IBinder b2 = callbacks.asBinder();
                    ConnectionRecord old = ServiceBinderImpl.this.this$0.mConnections.remove(b2);
                    if (old != null) {
        ...
        public void addSubscription(final String id, final IBinder token, final Bundle options, final ServiceCallbacks callbacks) {
            this.this$0.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.3
                @Override // java.lang.Runnable
                public void run() {
                    IBinder b2 = callbacks.asBinder();
                    ConnectionRecord connection = ServiceBinderImpl.this.this$0.mConnections.get(b2);
                    if (connection == null) {
        ...
        public void removeSubscription(final String id, final IBinder token, final ServiceCallbacks callbacks) {
            this.this$0.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.4
                @Override // java.lang.Runnable
                public void run() {
                    IBinder b2 = callbacks.asBinder();
                    ConnectionRecord connection = ServiceBinderImpl.this.this$0.mConnections.get(b2);
                    ...
                    } else if (!ServiceBinderImpl.this.this$0.removeSubscription(id, connection, token)) {
        ...
        public void getMediaItem(final String mediaId, final ResultReceiver receiver, final ServiceCallbacks callbacks) {
            ...
            this.this$0.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.5
                @Override // java.lang.Runnable
                public void run() {
                    IBinder b2 = callbacks.asBinder();
                    ConnectionRecord connection = ServiceBinderImpl.this.this$0.mConnections.get(b2);
        ...
        public void registerCallbacks(final ServiceCallbacks callbacks, final String pkg, final int pid, final int uid, final Bundle rootHints) {
            this.this$0.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.6
                @Override // java.lang.Runnable
                public void run() {
                    IBinder b2 = callbacks.asBinder();
                    ServiceBinderImpl.this.this$0.mConnections.remove(b2);
        ...
        public void unregisterCallbacks(final ServiceCallbacks callbacks) {
            this.this$0.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.7
                @Override // java.lang.Runnable
                public void run() {
                    IBinder b2 = callbacks.asBinder();
                    ConnectionRecord old = ServiceBinderImpl.this.this$0.mConnections.remove(b2);
                    if (old != null) {
                        b2.unlinkToDeath(old, 0);
                    }
                }
            });
        }
        ...
        public void search(final String query, final Bundle extras, final ResultReceiver receiver, final ServiceCallbacks callbacks) {
            ...
            this.this$0.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.8
                @Override // java.lang.Runnable
                public void run() {
                    IBinder b2 = callbacks.asBinder();
                    ConnectionRecord connection = ServiceBinderImpl.this.this$0.mConnections.get(b2);
        ...
        public void sendCustomAction(final String action, final Bundle extras, final ResultReceiver receiver, final ServiceCallbacks callbacks) {
            ...
            this.this$0.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.9
                @Override // java.lang.Runnable
                public void run() {
                    IBinder b2 = callbacks.asBinder();
                    ConnectionRecord connection = ServiceBinderImpl.this.this$0.mConnections.get(b2);
