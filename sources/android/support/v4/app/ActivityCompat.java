...
public class ActivityCompat extends ContextCompat {
    ...
    public static void setEnterSharedElementCallback(Activity activity, SharedElementCallback callback) {
        if (Build.VERSION.SDK_INT >= 23) {
            android.app.SharedElementCallback frameworkCallback = callback != null ? new SharedElementCallback23Impl(callback) : null;
            activity.setEnterSharedElementCallback(frameworkCallback);
        } else if (Build.VERSION.SDK_INT >= 21) {
            android.app.SharedElementCallback frameworkCallback2 = callback != null ? new SharedElementCallback21Impl(callback) : null;
            activity.setEnterSharedElementCallback(frameworkCallback2);
        }
    }
    ...
    public static void setExitSharedElementCallback(Activity activity, SharedElementCallback callback) {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            android.app.SharedElementCallback frameworkCallback2 = callback != null ? new SharedElementCallback21Impl(callback) : null;
            activity.setExitSharedElementCallback(frameworkCallback2);
        }
    }
