...
public class ViewPager extends ViewGroup {
    ...
    void dataSetChanged() {
            ...
            if (newPos != -1) {
                if (newPos == -2) {
                    ...
                    if (this.mCurItem == ii.position) {
                        newCurrItem2 = Math.max(0, Math.min(this.mCurItem, adapterCount - 1));
                        needPopulate2 = true;
                    }
        ...
        if (needPopulate2) {
            ...
            setCurrentItemInternal(newCurrItem2, false, true);
            requestLayout();
        }
    }
    ...
    */
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            this.widthFactor = 0.0f;
            TypedArray a2 = context.obtainStyledAttributes(attrs, ViewPager.LAYOUT_ATTRS);
            this.gravity = a2.getInteger(0, 48);
            a2.recycle();
        }
    }
