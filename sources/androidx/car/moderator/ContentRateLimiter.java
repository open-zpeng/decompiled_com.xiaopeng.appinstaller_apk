...
public class ContentRateLimiter {
    ...
    public boolean tryAcquire(int permits) {
        ...
        if (availablePermits <= permits) {
            ...
            return false;
        } else if (nowMs < this.mResumeIncrementingMs && this.mSecondaryFillDelayPermitAvailable) {
            ...
            setLastCalculatedPermitCount(availablePermits - permits, this.mFillDelayMs + nowMs);
            if (Log.isLoggable("ContentRateLimiter", 2)) {
