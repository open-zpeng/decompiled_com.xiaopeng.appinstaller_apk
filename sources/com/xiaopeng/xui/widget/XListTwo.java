...
public class XListTwo extends XRelativeLayout {
    ...
    private ColorStateList mTextSubColor;
    private ColorStateList mTextSubColorHighlight;
    ...
    public XListTwo(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setTextSubHighlight(obtainStyledAttributes.getBoolean(R.styleable.XListTwo_list_two_text_sub_highlight, false));
    ...
    private void initColor() {
        this.mTextSubColor = getResources().getColorStateList(R.color.x_list_text_sub_color_selector, null);
        this.mTextSubColorHighlight = getResources().getColorStateList(R.color.x_list_text_sub_highlight_color_selector, null);
    }
    ...
    public void onAttachedToWindow() {
        ...
        extendTouchRight();
        initColor();
        setTextSubHighlight(this.mHighlight);
    }
    ...
    public void setTextSubHighlight(boolean z) {
        this.mHighlight = z;
        this.mTextSub.setTextColor(z ? this.mTextSubColorHighlight : this.mTextSubColor);
    }
    ...
    public void showNum(boolean z) {
        ...
        if (viewGroup2 != null) {
            ...
            marginLayoutParams2.leftMargin = z ? dimensionPixelSize - dimensionPixelSize2 : 0;
