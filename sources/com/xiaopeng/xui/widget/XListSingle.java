...
public class XListSingle extends XRelativeLayout {
    ...
    public XListSingle(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (resourceId2 != -1) {
            marginLayoutParams = (ViewGroup.MarginLayoutParams) this.mText.getLayoutParams();
            resources = getResources();
            if (!z) {
                i3 = R.dimen.x_list_tv_margin_end;
                marginLayoutParams.setMarginEnd((int) resources.getDimension(i3));
        ...
        i3 = R.dimen.x_list_tv_has_tag_margin_end;
        marginLayoutParams.setMarginEnd((int) resources.getDimension(i3));
        this.mText.setLayoutParams(marginLayoutParams);
    }
