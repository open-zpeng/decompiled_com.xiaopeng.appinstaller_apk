package com.xiaopeng.xui.widget.quicksidebar.tipsview;
...
public class XQuickSideBarTipsItemView extends XView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (create != null && (xViewDelegate = this.mXViewDelegate) != null) {
            xViewDelegate.setFontScaleChangeCallback(new XViewDelegate.onFontScaleChangeCallback() { // from class: com.xiaopeng.xui.widget.quicksidebar.tipsview.-$$Lambda$XQuickSideBarTipsItemView$6ymJIzk4INXN_s4FIiuo6giZTcU
                @Override // com.xiaopeng.xui.view.XViewDelegate.onFontScaleChangeCallback
                public final void onFontScaleChanged() {
                    XQuickSideBarTipsItemView.this.a(create);
                }
            });
        }
