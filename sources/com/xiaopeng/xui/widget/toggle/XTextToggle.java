...
public class XTextToggle extends XToggleLayout {
    ...
    public XTextToggle(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (create != null && (xViewDelegate = this.mXViewDelegate) != null) {
            xViewDelegate.setFontScaleChangeCallback(new XViewDelegate.onFontScaleChangeCallback() { // from class: com.xiaopeng.xui.widget.toggle.-$$Lambda$XTextToggle$Q9xjdU8dHbWsQ8QCC6Et5h76sM8
                @Override // com.xiaopeng.xui.view.XViewDelegate.onFontScaleChangeCallback
                public final void onFontScaleChanged() {
                    XTextToggle.this.a(create);
                }
            });
        }
