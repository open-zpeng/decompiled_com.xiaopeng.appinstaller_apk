...
public class XLoadingDrawable extends Drawable {
    ...
    private void initParams() {
        ...
        if (this.mCenterX == 0.0f) {
            ...
            this.mColor = Xui.getContext().getResources().getColor(R.color.x_theme_text_01);
            int i = this.mCount;
    ...
    private void makeAnimations() {
        ...
        for (final int i2 = 0; i2 < i; i2++) {
            ...
            this.mAnimations[i2].addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.drawable.-$$Lambda$XLoadingDrawable$aCZ6oclm8lAZeeo9r6UrLPMlbzo
    ...
    public void cancelAnimations() {
        Log.d(TAG, "cancelAnimations: " + this);
