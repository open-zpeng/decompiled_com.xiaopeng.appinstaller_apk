...
public class XPanelActivity extends AppCompatActivity {
    ...
    private final Runnable mAutoDismissRunnable = new a();
    ...
    private ContentObserver mPanelObserver = new c(this.mPanelHandler);
    ...
    public void handleDismissEvent() {
        b bVar = new b(this.mDismissType);
        handleWindowVisibility(false);
        this.mPanelHandler.postDelayed(bVar, this.mDismissDelay);
    }
    ...
    public void onPostCreate(Bundle bundle) {
        ...
        if (i2 == 1) {
            height = getLayoutBuilder().setX(dp2px).setY(dp2px2).setWidth(dp2px3).setHeight(dp2px4);
            i = 17;
        } else if (i2 != 2) {
            return;
        } else {
