...
public class ThemeManager {
    ...
    public static class AttributeSet {
        ...
        public static final HashMap<String, Integer> sGlobalAttributeMap = new HashMap<>();

        static {
            sGlobalAttributeMap.clear();
        ...
        public static int getGlobalAttribute(String str) {
            if (hasGlobalAttribute(str)) {
                return sGlobalAttributeMap.get(str).intValue();
            }
            return 0;
        }
        ...
        public static boolean hasGlobalAttribute(String str) {
            if (TextUtils.isEmpty(str)) {
                return false;
            }
            return sGlobalAttributeMap.containsKey(str);
        }
    ...
    public static HashMap<String, Integer> resolveAttribute(Context context, android.util.AttributeSet attributeSet, int i, int i2, List<String> list) {
        return ThemeWrapper.resolveAttribute(context, attributeSet, i, i2, list);
    }
